...
/**
 * Extension on TypeUsages which contains all relevant information to calculate the strangeness score and display the
 * correct missing method call afterwards.
 */
